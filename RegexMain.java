...
//		System.out.println("hours: " + dateH);
		...
		String mmo = "06";
		String year = "2022";
		String corRef = "cor123/";
		String date = corRef + mmo + "/" + year;
		System.out.println(date);

		Matcher matcher = p.matcher(date);

		int dateMint = Integer.parseInt(mmo);
		int dateYint = Integer.parseInt(year);
		...
		if (matcher.find()) {
			...
			if (Integer.parseInt(dateM) - dateMint == 1) {
				...
				dateYint++;
				String yTmpInt = String.valueOf(dateYint);
				System.out.println("cor" + sTmpInt + "/" + dateM + "/" + yTmpInt);
